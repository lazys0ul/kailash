              ...
              <div className="bg-white rounded-lg shadow-md p-8 animate-fade-in animate-delay-100 hover-lift">
                ...
                <div className="space-y-4">
                  <div className="flex items-start animate-slide-up animate-delay-200">
                    <div className="bg-blue-100 p-3 rounded-lg mr-4 animate-bounce-in">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@kailashenterprises.com</p>
                    </div>
                  </div>

                  <div className="flex items-start animate-slide-up animate-delay-300">
                    <div className="bg-blue-100 p-3 rounded-lg mr-4 animate-bounce-in animate-delay-100">
                      <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
