...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 relative overflow-hidden cursor-custom page-transition">
      {/* Cursor Glow Effect */}
      <div 
      ...
      <main>
        ...
        <section className="py-16 bg-white animate-fade-in animate-delay-100">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center animate-slide-in-left hover-lift reveal-scale">
              ...
              <div className="text-center animate-slide-up animate-delay-200 hover-lift reveal-scale">
              ...
              <div className="text-center animate-slide-in-right hover-lift reveal-scale">
        ...
        <section className="py-16 bg-gray-100 animate-fade-in animate-delay-200">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 animate-slide-in-left relative overflow-hidden hover-tilt hover-lift card-shimmer reveal-left">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 animate-slide-up animate-delay-100 relative overflow-hidden hover-tilt hover-lift card-shimmer reveal">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 to-blue-600 animate-pulse-glow"></div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 animate-slide-in-right relative overflow-hidden hover-tilt hover-lift card-shimmer reveal-right">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 to-blue-600 animate-pulse-glow"></div>
